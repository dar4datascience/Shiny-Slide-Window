...
df <- google_geocode(address = "Coyoacan, Mexico City, Mexico",
                     simplify = TRUE)
...
plot_crs <- 4487 # this is the suggested CRS for COYOACAN
